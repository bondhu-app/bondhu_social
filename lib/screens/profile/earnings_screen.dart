...
class _EarningsScreenState extends State<EarningsScreen> {
                ...
                FilledButton(
                  onPressed: () async {
                    ...
                    if (amount == null || amount <= 0) {
                      _showMessage('সঠিক Withdraw Amount দিন।');
                      return;
                    }

                    if (account.isEmpty) {
                      _showMessage('Payment Account দিন।');
                      return;
                    }
  ...
  Future<void> _cancelWithdraw(String requestId) async {
    ...
    try {
      await _earningsService.cancelWithdrawRequest(requestId);
            ...
            child: ListView(
              ...
              children: [
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (docs.isEmpty) {
                      return _emptyBox(
                        ...
                        text: 'এখনও কোনো Transaction নেই।',
                      );
                    }
                ...
                StreamBuilder<
                    QuerySnapshot<Map<String, dynamic>>>(
                  stream:
                      _earningsService.myWithdrawRequestsStream(),
                  builder: (context, snapshot) {
                    if (snapshot.hasError) {
                      return _errorBox(
                        _cleanError(snapshot.error!),
